        ...
        <DialogContent>
          <div className="flex items-center justify-center w-full flex-col gap-5">
            <label
              ...
              className="flex flex-col items-center justify-center  mt-2  border-2 border-dashed rounded-lg cursor-pointer  border-primary"
            >
              <div
            ...
            <div className="flex  items-center justify-center w-full gap-10">
              ...
              <Button
                ...
                aria-disabled={status === "uploading" || file == null}
              >
                Upload
              </Button>
            </div>
